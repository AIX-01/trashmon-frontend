      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
        <div className="text-center md:text-left">
          ...
          <h1 className="font-jua text-5xl md:text-6xl leading-tight text-gray-900 mb-6">
            분리수거를 <span className="text-orange-500"> 보물</span>로 <br />
            만드는 놀라운 마법!
          </h1>
          <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
            지루한 잔소리 대신, 즐거운 게임으로!<br className="md:hidden"/><br />
            아이들 스스로 배우는 올바른 분리배출 습관.<br />
            <span className="font-bold text-green-700">Trash Monster</span>로 시작하세요.
          </p>
        ...
        <div className="relative mx-auto w-full max-w-md flex items-center justify-center">
          <div className="absolute -top-12 -left-12 w-32 h-32 transform -rotate-12 animate-bounce z-20">
            <Image src="/Glass.png" alt="유리 몬스터" layout="fill" objectFit="contain" />
          </div>
          <video
            className="rounded-2xl shadow-2xl border-4 border-gray-200 relative z-10"
            ...
            playsInline
          />
          <div className="absolute -bottom-12 -right-12 w-32 h-32 transform rotate-12 animate-bounce z-20">
            <Image src="/Paper.png" alt="종이 몬스터" layout="fill" objectFit="contain" />
          </div>
        </div>
      </div>
    </header>
